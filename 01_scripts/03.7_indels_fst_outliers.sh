...
# manitou
# srun -p small -c 1 -J 03.7_indels_fst_outliers -o log/03.7_indels_fst_outliers_%j.log /bin/sh 01_scripts/03.7_indels_fst_outliers.sh 10000 0.98 &

# valeria
# srun -p ibis_small -c 1 -J 03.7_indels_fst_outliers -o log/03.7_indels_fst_outliers_%j.log /bin/sh 01_scripts/03.7_indels_fst_outliers.sh 10000 0.98 &
