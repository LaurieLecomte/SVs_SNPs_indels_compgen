...
# manitou
# srun -p small -c 1 -J 01.7_SVs_fst_outliers -o log/01.7_SVs_fst_outliers_%j.log /bin/sh 01_scripts/01.7_SVs_fst_outliers.sh 10000 0.98 &

# valeria
# srun -p ibis_small -c 1 -J 01.7_SVs_fst_outliers -o log/01.7_SVs_fst_outliers_%j.log /bin/sh 01_scripts/01.7_SVs_fst_outliers.sh 10000 0.98 &
