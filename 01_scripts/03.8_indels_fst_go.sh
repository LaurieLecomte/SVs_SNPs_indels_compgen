...
# manitou
# srun -p small -c 1 -J 03.8_indels_fst_go -o log/03.8_indels_fst_go_%j.log /bin/sh 01_scripts/03.8_indels_fst_go.sh 10000 0.79 &

# valeria
# srun -p ibis_small -c 1 -J 03.8_indels_fst_go -o log/03.8_indels_fst_go_%j.log /bin/sh 01_scripts/03.8_indels_fst_go.sh 10000 0.79 &
