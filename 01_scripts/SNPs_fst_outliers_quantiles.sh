...
# manitou
# srun -p small -c 1 -J SNPs_fst_outliers_quantiles -o log/SNPs_fst_outliers_quantiles_%j.log /bin/sh 01_scripts/SNPs_fst_outliers_quantiles.sh 10000 0.98 &

# valeria
# srun -p ibis_small -c 1 -J SNPs_fst_outliers_quantiles -o log/SNPs_fst_outliers_quantiles_%j.log /bin/sh 01_scripts/SNPs_fst_outliers_quantiles.sh 10000 0.98 &
