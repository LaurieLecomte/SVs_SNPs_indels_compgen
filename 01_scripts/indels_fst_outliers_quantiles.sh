...
# Extract outlier indels by computing quantiles, and get overlap between these outlier and known genes, while allowing a 10000 bp window around genes
...
# manitou
# srun -p small -c 1 -J indels_fst_outliers_quantiles -o log/indels_fst_outliers_quantiles_%j.log /bin/sh 01_scripts/indels_fst_outliers_quantiles.sh 10000 0.98 &

# valeria
# srun -p ibis_small -c 1 -J indels_fst_outliers_quantiles -o log/indels_fst_outliers_quantiles_%j.log /bin/sh 01_scripts/indels_fst_outliers_quantiles.sh 10000 0.98 &
