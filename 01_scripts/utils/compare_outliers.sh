...
# manitou
# srun -p small -c 1 -J 01.13_SVs_compare_outliers -o log/01.13_SVs_compare_outliers_%j.log /bin/sh 01_scripts/01.13_SVs_compare_outliers.sh 10000 0.985 3 0.01 &

# valeria
# srun -p ibis_small -c 1 -J 01.13_SVs_compare_outliers -o log/01.13_SVs_compare_outliers_%j.log /bin/sh 01_scripts/01.13_SVs_compare_outliers.sh 10000 0.985 3 0.001 &
...
echo "$OVERLAP_WIN $QUANTILE $MIN_FST $SD $MAX_QVAL"
