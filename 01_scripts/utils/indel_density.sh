...
bedtools intersect -a 02_infos/chrs_win"$WIN_SIZE".bed -b $RDA_DIR/"$(basename -s .vcf.gz $RAW_FST_VCF)".CHR_POS_END_ID.bed -c > $DENSITY_DIR/indels_density_win"$WIN_SIZE"bp.txt
