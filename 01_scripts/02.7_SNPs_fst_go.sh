...
# manitou
# srun -p small -c 1 -J 02.7_SNPs_fst_go -o log/02.7_SNPs_fst_go_%j.log /bin/sh 01_scripts/02.7_SNPs_fst_go.sh 10000 0.65 &

# valeria
# srun -p ibis_small -c 1 -J 02.7_SNPs_fst_go -o log/02.7_SNPs_fst_go_%j.log /bin/sh 01_scripts/02.7_SNPs_fst_go.sh 10000 0.65 &
